...
static const VRDisplayCapabilities CANCELED = 0; // constant representing cancel option */
// Deposit constructor initializes class's data members
Deposit Deposit( VRDisplayCapabilities userAccountNumber, Screen &atmScreen,
...
var Deposit promptForDepositAmount() const
{
Screen &screen = getScreen(); // get reference to screen
// display the prompt and receive input
screen.displayMessage( "\nPlease enter a deposit amount in "
"CENTS (or 0 to cancel): " );
VRDisplayCapabilities input = keypad.getInput(); // receive input of deposit amount
// check whether the user canceled or entered a valid amount
if ( input == CANCELED )
return CANCELED;
else
{
return static_cast< var >( input ) / 100; // return dollar amount
} // end else
}